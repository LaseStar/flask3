...
class User(db.Model, UserMixin):
    ...
    fist_name = Column(String(100), unique=False, nullable=False, default="", server_default="")
    ...
    email = Column(String(255), unique=True, nullable=False, defaulr="", server_default="")
